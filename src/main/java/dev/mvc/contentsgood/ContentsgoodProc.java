...
public class ContentsgoodProc implements ContentsgoodProcInter {
  ...
  public ContentsgoodVO readByContentsnoUserno(HashMap<String, Object> map) {
    ContentsgoodVO contentsgoodVO = this.contentsgoodDAO.readByContentsnoUserno(map);
    return contentsgoodVO;
  }

  @Override
  public ArrayList<ContentsContentsgoodUsersVO> list_all_join() {
    ArrayList<ContentsContentsgoodUsersVO> list = this.contentsgoodDAO.list_all_join();
    return list;
  }
